...
const Project = () => {
    ...
    const project = {
        intro: "MY WORKS",
        head: "Projects",
        body:"Following are the projects that showcases my skills and experience through real-world examples of my work. "+
    ...
    const hobbies = {
        ...
        head: "Hobbies",
        body:'As a person that is somewhat in the middle of the introvert-extrovert spectrum. I enjoy doing this such as playing music,'+
    ...
    const projects = [
        {name: "Player Search App (Dominate.gg)",
         desc: "A independent project that I created for fun. This website allows users to fetch game data of players in "+
        ...
        {name: "My Portfolio",
        desc: "My responsive personal portfolio that contains some informations and things about my life. this includes things such as my education,"+
        "skills and work experience. ",
        image: "/src/assets/portfolioPic.png",
        language:[
            'HTML5','JavaScript','ReactJS','TailwindCSS'
        ] ,
        color: "blue"
        }
    ]
    ...
    return(
        ...
        <div className='text-white bg-black lg:px-10 pt-10 pb-16 md:pb-24'>
            <motion.div ref={ref} className=" lg:flex "
                initial={{opacity:0, y:200}}
                animate={animation}
            >
                <div className="w-full sm:w-11/12 px-1 lg:pl-2 mx-auto">
                    ...
                    <div className="h-56 md:h-72 lg:h-96 w-10/12 mx-auto lg:w-full relative">
                        <img className="absolute w-48 md:w-64 lg:w-72 top-0 sm:top-0 left-14 md:left-10" src={Guitar}></img>
                        <img className="absolute w-40 md:w-64 lg:w-52 top-10 sm:top-0 lg:top-20 left-1/2 sm:left-80 lg:left-1/2" src={Controller}></img>
                    </div>
                </div>
                <div id='works' className="w-full sm:w-11/12 px-1 lg:pl-2 mx-auto">
                    <div className="w-10/12 lg:w-full xl:w-10/12 mx-auto">
                    ...
                    <div className="w-fit sm:w-10/12 lg:w-fit mx-auto sm:flex">
